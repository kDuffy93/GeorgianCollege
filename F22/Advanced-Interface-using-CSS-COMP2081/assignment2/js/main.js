...
That goddam bridge.`,
    2: `We lived halfway up the long length of Sycamore Street Hill, about a quarter of a mile from the bridge. There was a little gas-and-convenience store on the other side called Zip Mart. It sold all the usual stuff, from motor oil to Wonder Bread to Little Debbie cakes, but it also sold fried chicken made by the proprietor, Mr. Eliades (known to the neighborhood as Mr. Zippy). That chicken was exactly what the sign in the window said: THE BEST IN THE LAND. I can still remember how tasty it was, but I never ate a single piece after my mom died. I would have gagged it up if I tried.
...
“I try not to. And mostly I can do that unless I wake up at two in the morning with nobody in the bed but me. Then I blame him.”`,
    3: `Mom walked down the hill. There was a sign where the sidewalk ended. She walked past the sign and crossed the bridge. By then it was getting dark and starting to drizzle. She went into the store, and Irina Eliades (of course known as Mrs. Zippy) told her more chicken was coming out in three minutes, five at the most. Somewhere on Pine Street, not far from our house, the plumber had just finished his last job of that Saturday and was putting his toolbox in the back of his panel van.
...
I carry a picture of us in my wallet. I was maybe three when it was taken. She’s got me on her hip. One of my hands is in her hair. She had beautiful hair.`,
    4: `Shitty Christmas that year. You better believe it.
...
“I call bullshit,” I said, and went into my room.`,
    5: `That was the worst summer of my childhood. Was it worse than after your mother died? you could ask, and I’d say yes, because he was the only parent I had left and because it all seemed to be happening in slow motion.
...
let buildExcerpt = (pageData, page) => {
    ...
    newContent.textContent = pageData;
